...
<sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
   ...
   <sch:pattern id="sch_lvbba_BHKV1014" see="lvbba:InformatieObjectVersie">
      ...
      <sch:rule context="lvbba:InformatieObjectVersie">
         ...
         <sch:assert id="BHKV1014"
            ...
            role="fout"> {"code": "BHKV1014", "Expression-ID": "<sch:value-of
               select="$Expression-ID" />", "melding": "Element data:heeftBestanden van <sch:value-of
               select="$Expression-ID" /> moet bestaan uit één bestand. In de aanlevering zitten
            meer of minder dan één bestand. Dit is niet toegestaan, lever precies één bestand aan.",
   ...
   <sch:pattern id="sch_lvbba_023" see="data:heeftGeboorteregeling">
      ...
      <sch:rule
         ...
         <sch:assert id="BHKV1015" test="//data:heeftGeboorteregeling" role="fout">{"code":
            "BHKV1015", "id": "<sch:value-of select="//data:FRBRExpression" />", "melding":
            "heeftGeboorteregeling voor <sch:value-of select="//data:FRBRExpression" /> is niet
            aanwezig, is verplicht wanneer soortWork=/join/id/stop/work_010 èn
            formaatinformatieobject=/join/id/stop/informatieobject/gio_002. Voeg de
            AKN-identificatie voor heeftGeboorteregeling toe.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <!--  -->
   <sch:pattern id="sch_lvbba_024">
      ...
      <sch:rule
         ...
         <sch:p>De identificatie van een InformatieObject moet als soort werk
            '/join/id/stop/work_010'
            zijn</sch:p>
         <sch:assert id="BHKV1016"
            test="normalize-space(data:soortWork) = '/join/id/stop/work_010'"
            role="fout">{"code": "BHKV1016", "work": "<sch:value-of select="data:soortWork" />",
            "id": "<sch:value-of select="data:FRBRExpression" />", "melding": "Het aangeleverde
            informatieobject <sch:value-of select="data:FRBRExpression" /> heeft als soortWork <sch:value-of
               select="data:soortWork" /> dit moet '/join/id/stop/work_010' zijn.", "ernst":
            "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <!--  -->
   <sch:pattern id="sch_lvbba_025">
      ...
      <sch:rule
         ...
         <sch:assert id="BHKV1017" test="$work = $titel" role="fout"> {"code": "BHKV1017", "work": "<sch:value-of
               select="$work" />", "titel": "<sch:value-of select="$titel" />", "melding": "De
            officiele titel <sch:value-of select="$titel" /> komt niet overeen met de identifier
            FRBRWork <sch:value-of select="$work" />", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <!--  -->
   <sch:pattern id="sch_lvbba_026">
      <sch:title>De collectie gebruikt in de AKN identifier van een informatieobject MOET
         overeenkomen met zijn data:publicatieinstructie</sch:title>
      <sch:rule
         context="lvbba:InformatieObjectVersie/data:InformatieObjectMetadata/data:publicatieinstructie">
         <sch:let name="work"
            value="normalize-space(ancestor::lvbba:InformatieObjectVersie/data:ExpressionIdentificatie/data:FRBRWork)" />
         ...
         <sch:assert id="BHKV1018"
            ...
            role="fout"> {"code": "BHKV1018", "Work-ID": "<sch:value-of select="$work" />",
            "substring": "<sch:value-of select="./string()" />", "melding": "De collectie in de
            FRBRWork identifier <sch:value-of select="$work" /> komt niet overeen met de
            publicatieinstructie <sch:value-of select="./string()" />", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern id="sch_lvbba_027">
      ...
      <sch:rule
         context="lvbba:InformatieObjectVersie/se:FeatureTypeStyle[preceding-sibling::data:InformatieObjectMetadata]">
         ...
         <sch:assert id="BHKV1064"
            ...
            role="fout"> {"code": "BHKV1064", "Expressie": "<sch:value-of
               select="normalize-space(preceding-sibling::data:ExpressionIdentificatie/data:FRBRExpression)" />",
            "Module": "<sch:value-of select="node-name(.)" />", "formaat": "<sch:value-of
               select="$formaat" />", "melding": "De aanlevering van <sch:value-of
               select="normalize-space(preceding-sibling::data:ExpressionIdentificatie/data:FRBRExpression)" />
            mag de module <sch:value-of select="node-name(.)" /> niet bevatten omdat het
            formaatInformatieobject(<sch:value-of select="$formaat" />) niet
            \"/join/id/stop/informatieobject/gio_002\"(GIO) is. Verwijder de module of wijzig het
            formaat.", "ernst": "fout"},</sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern id="sch_lvbba_028">
      <sch:title>De module gio:JuridischeBorgingVan MAG ALLEEN bij een Geoinformatieobject
         aangeleverd worden.</sch:title>
      <sch:rule
         context="lvbba:InformatieObjectVersie/gio:JuridischeBorgingVan[preceding-sibling::data:InformatieObjectMetadata]">
         <sch:let name="formaat"
            value="preceding-sibling::data:InformatieObjectMetadata/data:formaatInformatieobject/string()" />
         <sch:assert id="BHKV1065"
            test="$formaat = '/join/id/stop/informatieobject/gio_002'"
            role="fout"> {"code": "BHKV1065", "Expressie": "<sch:value-of
               select="normalize-space(preceding-sibling::data:ExpressionIdentificatie/data:FRBRExpression)" />",
            "Module": "<sch:value-of select="node-name(.)" />", "formaat": "<sch:value-of
               select="$formaat" />", "melding": "De aanlevering van <sch:value-of
               select="normalize-space(preceding-sibling::data:ExpressionIdentificatie/data:FRBRExpression)" />
