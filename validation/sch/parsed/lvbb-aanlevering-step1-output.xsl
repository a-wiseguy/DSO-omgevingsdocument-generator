<?xml version="1.0" encoding="UTF-8"?><sch:schema xmlns:data="https://standaarden.overheid.nl/stop/imop/data/" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2">
   ...
   <sch:pattern id="sch_lvbba_003">
      ...
      <sch:rule context="lvbba:AanleveringBesluit//data:BeoogdInformatieobject">
         ...
         <sch:assert id="BHKV1036" test="$verzamelXioRefs/set/id[. = $data-eId] and $verzamelXioRefs/set[id[. = $data-eId]]/join = $joinID" role="fout"> {"code": "BHKV1036", "eId": "<sch:value-of select="$data-eId"/>",
   ...
   <sch:pattern id="sch_lvbba_004">
      ...
      <sch:rule context="data:BesluitMetadata/data:soortProcedure[normalize-space(./string()) = '/join/id/stop/proceduretype_ontwerp']">
         ...
         <sch:report id="BHKV1004" test="ancestor::lvbba:AanleveringBesluit//data:ConsolidatieInformatie/data:Tijdstempels" role="fout"> {"code": "BHKV1004", "melding": "Het ontwerpbesluit heeft tijdstempels, dit
   ...
   <sch:pattern id="sch_lvbba_005">
      ...
      <sch:rule context="lvbba:AanleveringBesluit/lvbba:BesluitVersie">
         <sch:let name="soortWork" value="normalize-space(data:ExpressionIdentificatie/data:soortWork/./string())"/>
         <sch:p>De identificatie van het besluit moet als soort werk '/join/id/stop/work_003'
            hebben</sch:p>
         <sch:assert id="BHKV1005" test="$soortWork = '/join/id/stop/work_003'" role="fout">{"code": "BHKV1005", "id": "<sch:value-of select="$soortWork"/>",
   ...
   <sch:pattern id="sch_lvbba_006">
      ...
      <sch:rule context="tekst:RegelingCompact | tekst:RegelingKlassiek | tekst:RegelingVrijetekst">
         ...
         <sch:assert id="BHKV1006" test="contains($controle, '|GOED|')" role="fout">{"code":
            "BHKV1006", "id": "<sch:value-of select="normalize-space(replace($controle, ' /', ', /'))"/>", "melding": "Het
            geleverde regelingversie heeft als soortWork '<sch:value-of select="normalize-space(replace($controle, ' /', ', /'))"/>'. Dit moet voor een
   ...
   <sch:pattern id="sch_lvbba_009">
      ...
      <sch:rule context="data:BeoogdeRegeling">
         ...
         <sch:assert id="BHKV1009" test="           ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:Artikel[@eId = $matchId][not(ancestor::tekst:WijzigBijlage)] |           ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:WijzigArtikel[@eId = $matchId][not(ancestor::tekst:WijzigBijlage)] |           ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:Artikel[@eId = $matchId][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |           ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:WijzigArtikel[@eId = $matchId][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |           ancestor::lvbba:AanleverenRectificatie//tekst:BesluitMutatie[@componentnaam = $component]//tekst:*[@eId = $matchId]" role="fout"> {"code": "BHKV1009", "eId": "<sch:value-of select="$eId"/>", "regeling": "<sch:value-of select="data:instrumentVersie"/>", "melding": "In het besluit of rectificatie is de
            eId <sch:value-of select="$eId"/> voor de BeoogdeRegeling <sch:value-of select="data:instrumentVersie"/> niet te vinden. Controleer de referentie naar het
   ...
   <sch:pattern id="sch_lvbba_010">
      ...
      <sch:rule context="data:ConsolidatieInformatie/data:Tijdstempels/data:Tijdstempel[data:eId]">
         ...
         <sch:assert id="BHKV1010" test="           ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:Artikel[@eId = $matchID][not(ancestor::tekst:WijzigBijlage)] |           ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:Artikel[@eId = $matchID][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |           ancestor::lvbba:AanleverenRectificatie//tekst:BesluitMutatie[@componentnaam = $component]//tekst:*[@eId = $matchID]" role="fout"> {"code": "BHKV1010", "eId": "<sch:value-of select="$refID"/>", "melding":
   ...
   <sch:pattern id="sch_lvbba_011">
      ...
      <sch:rule context="data:ConsolidatieInformatie/data:Intrekkingen/data:Intrekking[starts-with(xs:string(data:instrument), '/akn/')]">
         ...
         <sch:assert id="BHKV1011" test="           ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:Artikel[@eId = $matchID][not(ancestor::tekst:WijzigBijlage)] |           ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:WijzigArtikel[@eId = $matchID][not(ancestor::tekst:WijzigBijlage)] |                  ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:Artikel[@eId = $matchID][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |           ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:WijzigArtikel[@eId = $matchID][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |           ancestor::lvbba:AanleverenRectificatie//tekst:BesluitMutatie[@componentnaam = $component]//tekst:*[@eId = $matchID]" role="fout"> {"code": "BHKV1011", "eId": "<sch:value-of select="$refID"/>",
   ...
   <sch:pattern id="sch_lvbba_021">
      ...
      <sch:rule context="tekst:RegelingTijdelijkdeel">
         ...
         <sch:assert id="BHKV1028" test="ancestor::lvbba:AanleveringBesluit//data:ExpressionIdentificatie[normalize-space(xs:string(data:soortWork)) = $soortWork][normalize-space(xs:string(data:FRBRExpression)) = $wordt]" role="fout"> {"code": "BHKV1028", "id": "<sch:value-of select="$wordt"/>", "melding":
            "Het besluit heeft tekst:RegelingTijdelijkdeel met attribuut wordt=\"<sch:value-of select="$wordt"/>\", maar data:ExpressionIdentificatie met <sch:value-of select="$wordt"/> ontbreekt, of heeft als data:soortWork geen
   ...
   <sch:pattern id="sch_lvbba_044">
      ...
      <sch:rule context="lvbba:AanleveringBesluit//tekst:*[@componentnaam]">
         ...
         <sch:assert id="BHKV1044" test="$worden = 1" role="fout"> {"code": "BHKV1044", "wordt": "<sch:value-of select="normalize-space($wordt)"/>", "component": "<sch:value-of select="@componentnaam"/>", "melding": "Er moet versieinformatie meegeleverd worden
            voor \"<sch:value-of select="normalize-space($wordt)"/>\" van component \"<sch:value-of select="@componentnaam"/>\", deze ontbreekt <sch:value-of select="$melding"/>. Voeg
   ...
   <sch:pattern id="sch_lvbba_046">
      ...
      <sch:rule context="lvbba:AanleveringBesluit/lvbba:BesluitVersie/data:Procedureverloop/data:procedurestappen">
         <sch:assert id="BHKV1046" test="not(data:Procedurestap[data:soortStap[. = '/join/id/stop/procedure/stap_004']])" role="fout">
   ...
   <sch:pattern id="sch_lvbba_047">
      ...
      <sch:rule context="lvbba:AanleveringBesluit/lvbba:BesluitVersie/data:Procedureverloop/data:procedurestappen[normalize-space(ancestor::lvbba:BesluitVersie/data:BesluitMetadata/data:soortProcedure/./string()) = '/join/id/stop/proceduretype_definitief']">
         ...
         <sch:assert id="BHKV1048" test="data:Procedurestap[normalize-space(data:soortStap/./string()) = '/join/id/stop/procedure/stap_003']" role="fout">
   ...
   <sch:pattern id="sch_lvbba_057">
      ...
      <sch:rule context="lvbba:AanleveringKennisgeving//data:Procedureverloop/data:procedurestappen/data:Procedurestap/data:soortStap">
         <sch:let name="stappen" value="'/join/id/stop/procedure/stap_005|/join/id/stop/procedure/stap_014|/join/id/stop/procedure/stap_016|/join/id/stop/procedure/stap_015'"/>
         <sch:p>Bij een kennisgeving alleen de volgende procedurestappen</sch:p>
         <sch:assert id="BHKV1057" test="matches(normalize-space(./text()), $stappen)" role="fout"> {"code": "BHKV1057", "soortStap": "<sch:value-of select="normalize-space(./text())"/>", "melding": "Procedurestap \"<sch:value-of select="normalize-space(./text())"/>\" is niet toegestaan bij een Aanlevering
   ...
   <sch:pattern id="sch_lvbba_063">
      ...
      <sch:rule context="data:ConsolidatieInformatie/data:Intrekkingen/data:Intrekking[starts-with(xs:string(data:instrument), '/join/id/')]">
         ...
         <sch:assert id="bhkv1063" test="         ancestor::lvbba:BesluitVersie/tekst:BesluitCompact/tekst:WijzigBijlage//tekst:RegelingMutatie[@componentnaam = $component]//tekst:ExtIoRef[@eId = $matchID][ancestor::tekst:Verwijder or ancestor::tekst:*/@wijzigactie='verwijder' or ancestor::tekst:VerwijderdeTekst] |         ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:RegelingMutatie[@componentnaam = $component]//tekst:ExtIoRef[@eId = $matchID][ancestor::tekst:Verwijder or ancestor::tekst:*/@wijzigactie='verwijder' or ancestor::tekst:VerwijderdeTekst]" role="fout"> {"code": "BHKV1063", "eId": "<sch:value-of select="$refID"/>",
            "instrumentIO": "<sch:value-of select="data:instrument"/>", "melding": "De eId(<sch:value-of select="$refID"/>) van de data:Intrekking van <sch:value-of select="data:instrument"/>
   ...
   <sch:pattern id="sch_lvbba_066">
      ...
      <sch:rule context="data:BesluitMetadata[data:soortProcedure='/join/id/stop/proceduretype_definitief']">
         <sch:assert id="BHKV1066" test="ancestor::lvbba:BesluitVersie/data:Procedureverloop" role="fout"> {"code": "BHKV1066", "expressie-id": "<sch:value-of select="ancestor::lvbba:BesluitVersie/data:ExpressionIdentificatie/data:FRBRExpression"/>",
            "melding": "Het aangeleverde besluit(<sch:value-of select="ancestor::lvbba:BesluitVersie/data:ExpressionIdentificatie/data:FRBRExpression"/>)
   ...
   <sch:pattern id="sch_lvbba_067">
      ...
      <sch:rule context="data:KennisgevingMetadata">
         <sch:let name="KennisgevingBesluittermijnen" value="data:soortKennisgeving = 'KennisgevingBesluittermijnen' or not(data:soortKennisgeving)"/>
         <sch:assert id="BHKV1067" test="($KennisgevingBesluittermijnen and ../data:Procedureverloopmutatie and data:mededelingOver) or not($KennisgevingBesluittermijnen)" role="fout"> {"code": "BHKV1067", "expressie-id": "<sch:value-of select="../data:ExpressionIdentificatie/data:FRBRExpression"/>", "melding":
            "AanleveringKennisgeving \"<sch:value-of select="../data:ExpressionIdentificatie/data:FRBRExpression"/>\" heeft als
